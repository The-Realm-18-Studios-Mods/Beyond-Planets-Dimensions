...
public class PlanetsRegistry {
    public static final ResourceKey<Level> sunFlowerPlanet1 = ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation(BeyondPlanets.MODID, "sunflower_planet"));
